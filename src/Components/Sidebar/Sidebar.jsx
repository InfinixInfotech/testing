...
const Sidebar = () => {
  ...
  const NavItem = ({ to, icon, text, id }) => (
    <li className="nav-item">
      <NavLink
        to={to}
        className={`nav-link text-white d-flex align-items-center px-3 py-2 w-100 ${activeItem === id ? "bg-primary" : ""
          }`}
  ...
  return (
    <>
      ...
      >
        ...
        <nav className="flex-grow-1">
          <ul className="nav flex-column p-0">
            <li className="nav-item">
              ...
              <div
                className={`nav-link text-white d-flex align-items-center px-3 py-2 w-100 ${activeItem === "compose" ? "bg-primary" : ""
                  }`}
              ...
              >
                ...
                <span>Compose</span>
                <i
                  className={`fas fa-chevron-${isDropdownOpen.compose ? "up" : "down"
                    } ms-auto`}
                ></i>
              </div>
        ...
        <div className="d-flex flex-row align-items-center justify-content-center mb-5 bg-white">
  <img
    src={Logo}
    alt="logo"
    style={{ width: "78px", height: "78px", marginRight: "8px" }}
  />
